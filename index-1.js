   ...
   if (messageType == 'imageMessage')
   {
    ...
    const
         ...
         exec('cwebp -q 50 ' + stiker + ' -o temp/' + jam + '.webp', (error, stdout, stderr) =>
         {
            ...
            conn.sendMessage(id, stik, MessageType.sticker), {quoted: m,caption:''})
         });
      }
   }
...
if (text.includes("_lirik")){
	...
	conn.sendMessage(id, hasil, MessageType.text), {quoted: m,caption:''})
	})
}
  if ( text == '_ptl cewek') 
...
if (text.includes("_anime"))
   {
	...
	var buf = Buffer.from(response, 'base64'); 
              conn.sendMessage(
            id,
              buf,MessageType.image), {quoted: m,caption:'Nih bang hentong nya :)'})
