...
if (text.includes('_igStalk')){
  var teks = text.replace(/_igStalk /, '')
...
if (text.includes("_igStalk")){
const teks = text.replace(/_igStalk /, "")
...
if (text.includes("_spamgmail")){
const teks = text.replace(/_spamgmail /, "")
...
if (text.includes('_profileig')){
  var teks = text.replace(/_profileig /, '')
    axios.get('https://arugaz.herokuapp.com/api/stalk?username='+teks)
    .then((res) => {
      imageToBase64(res.data.Profile_pic)
        .then(
...
if (text.includes("_ping")){
const teks = text.replace(/_ping /, "")
axios.get(`https://api.banghasan.com/domain/nping/${teks}`).then((res) => {
 ...
 if (text.includes("_hostsearch")){
const teks = text.replace(/_hostsearch /, "")
axios.get(`https://api.banghasan.com/domain/hostsearch/${teks}`).then((res) => {
 ...
 if (text.includes("_infogempa")){
const teks = text.replace(/_infogempa /, "")
axios.get(`https://arugaz.herokuapp.com/api/infogempa`).then((res) => {
  ...
  if (text.includes("_jadwalTVnow")){
const teks = text.replace(/_jadwalTV /, "")
...
axios.get(`https://st4rz.herokuapp.com/api/simsimi?kata=${teks}`).then((res) => {
 ...
 if (text.includes("_bitly")){
const teks = text.replace(/_bitly /, "")
conn.sendMessage(id, '[[] SEDANG DIPROSES', MessageType.text)
...
if (text.includes("_spamsms")){
const teks = text.replace(/_spamsms /, "")
...
if (text.includes("_checkip"))
  { const teks = text.replace(/_checkip /, "") 
 ...
 if (text.includes('_cooltext')){
  var teks = text.replace(/_cooltext /, '')
...
if (text.includes('_map')){
  var teks = text.replace(/_map /, '')
...
if (text.includes('_ssweb')){
  var teks = text.replace(/_ssweb /, '')
...
axios.get(`https://alfians-api.herokuapp.com/api/wiki?q=${wow}`).then((res) => {
    let hasil = `${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
if (text.includes("_ytmp4"))
   {
      const url = text.replace(/_ytmp4 /, "");
